...
const GunsSolverFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gunssolver_free(ptr >>> 0, 1));
...
export class GunsSolver {
     ...
     */
    solve_pow() {
        const ret = wasm.gunssolver_solve_pow(this.__wbg_ptr);
        console.log(ret);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('_gunslolpow_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
